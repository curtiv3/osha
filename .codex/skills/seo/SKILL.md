...
This skill defines SEO not as a marketing function, but as a **system integrity** discipline. Your goal is to ensure it, provides deterministic, accurately structured signals to search engine crawlers (Googlebot, Bingbot) and social user agents (Slackbot, Twitterbot, iMessage).
